...
void ICACHE_FLASH_ATTR supla_esp_system_restart(void) {
...
int ICACHE_FLASH_ATTR supla_esp_data_read(void *buf, int count, void *dcd) {
...
int ICACHE_FLASH_ATTR supla_esp_data_write(void *buf, int count, void *dcd) {
...
void ICACHE_FLASH_ATTR supla_esp_on_version_error(TSDC_SuplaVersionError *version_error) {
...
void ICACHE_FLASH_ATTR supla_esp_on_register_result(TSD_SuplaRegisterDeviceResult *register_device_result) {
...
void ICACHE_FLASH_ATTR supla_esp_channel_set_activity_timeout_result(TSDC_SuplaSetActivityTimeoutResult *result) {
...
void ICACHE_FLASH_ATTR supla_esp_channel_rgbw_value_changed(int channel_number, int color, char color_brightness, char brightness) {
...
char ICACHE_FLASH_ATTR _supla_esp_channel_set_value(int port, char v, int channel_number) {
...
char ICACHE_FLASH_ATTR supla_esp_channel_set_rgbw__value(int ChannelNumber, int Color, char ColorBrightness, char Brightness) {
	supla_esp_channel_set_rgbw_value(ChannelNumber, &Color, &ColorBrightness, &Brightness);
}

#endif

void ICACHE_FLASH_ATTR supla_esp_channel_set_value(TSD_SuplaChannelNewValue *new_value) {
...
void ICACHE_FLASH_ATTR supla_esp_on_remote_call_received(void *_srpc, unsigned int rr_id, unsigned int call_type, void *_dcd, unsigned char proto_version) {
